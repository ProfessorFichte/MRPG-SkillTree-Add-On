...
public class WitcherSkillSpells {
    ...
    public static final MrpgSkillSpells.Entry sign_tier_spell_2_root_1 = add(MrpgSkillsCommon.critRoot(
            ...
            "sign_tier_spell_2_root_1", "witcher_rpg:igni", "Igni", 0.05F));
    ...
    public static final MrpgSkillSpells.Entry sign_tier_spell_3_root_2 = add(MrpgSkillsCommon.lingerRoot(
            MrpgSkillSpells.Category.WITCHER, MrpgSkillSpells.witcherSignSchool,
            "sign_tier_spell_3_root_2", "witcher_rpg:axii", "Axii", 1F));
    public static final MrpgSkillSpells.Entry sign_tier_spell_4_root_1 = add(MrpgSkillsCommon.critRoot(
            MrpgSkillSpells.Category.WITCHER, MrpgSkillSpells.witcherSignSchool,
            "sign_tier_spell_4_root_1", "witcher_rpg:igni_firestream", "Igni Firestream", 0.05F));
    public static final MrpgSkillSpells.Entry sign_tier_spell_4_root_2 = add(MrpgSkillsCommon.radiusRoot(
            MrpgSkillSpells.Category.WITCHER, MrpgSkillSpells.witcherSignSchool,
            "sign_tier_spell_4_root_2", "witcher_rpg:aard_sweep", "Aard Sweep", 1F));
    ...
    public static final MrpgSkillSpells.Entry fencing_tier_spell_2_root_1 = add(MrpgSkillsCommon.critRoot(
            ...
            "fencing_tier_spell_2_root_1", "witcher_rpg:fast_attack", "Fast Attacks", 0.05F));
    public static final MrpgSkillSpells.Entry fencing_tier_spell_2_root_2 = add(MrpgSkillsCommon.powerRoot(
            MrpgSkillSpells.Category.WITCHER, MrpgSkillSpells.witcherFencingSchool,
            "fencing_tier_spell_2_root_2", "witcher_rpg:strong_attack", "Strong Attacks", 0.1F));
    ...
    public static final MrpgSkillSpells.Entry fencing_tier_spell_4_root_1 = add(MrpgSkillsCommon.critRoot(
            MrpgSkillSpells.Category.WITCHER, MrpgSkillSpells.witcherFencingSchool,
            "fencing_tier_spell_4_root_1", "witcher_rpg:whirl", "Whirl", 0.1F));
    public static final MrpgSkillSpells.Entry fencing_tier_spell_4_root_2 = add(MrpgSkillsCommon.powerRoot(
            MrpgSkillSpells.Category.WITCHER, MrpgSkillSpells.witcherFencingSchool,
            "fencing_tier_spell_4_root_2", "witcher_rpg:rend", "Rend", 0.1F));
}
